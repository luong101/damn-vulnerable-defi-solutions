...
contract CurvyPuppetChallenge is Test {
    ...
    function test_curvyPuppet() public checkSolvedByPlayer {
        ...
        Rescue rescue = new Rescue(curvePool, lending, curveLpToken, address(player), TREASURY_LP_BALANCE,stETH,weth,address(treasury),dvt);
        curveLpToken.transferFrom(address(treasury), address(rescue), TREASURY_LP_BALANCE);
        weth.transferFrom(address(treasury), address(rescue), TREASURY_WETH_BALANCE);
        rescue.execute();
